...
The decision tree model with boosting trials that helps identify the types of defects a steel plate has can provide a useful business applications for manufacturers. This model will help the faults to be detected and identified as early as possible to help the manufacturers employ proper precautionary measures early on. In addition, "The predictions that our model provides using machine learning techniques will be able to provide timely diagnosis for faults t
